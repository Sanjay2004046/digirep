	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
					<a href="#" class="btn btn-info btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#assignment"><i class="fa fa-eye"></i>Assignment</a>
				</div>
			</div>
		</div>
			...
			<table class="table table-bordered table-hover table-striped">
							<thead>
							 ...
							 <tbody>
								 ...
								 <tr>
								 <td rowspan="10"><a href="mailto:kit.25.21bcb002@gmail.com?&body=
											 <?php 
					...
					<table class="table table-bordered table-hover table-striped">
							<thead>
							 ...
							 <tbody>
							 	...
							 	<tr>
								 <td><?php echo $cnt;?></td>
									<td><?php echo $result['email']; ?> (<?php echo $result['name']; ?>)</td>
        							<td><a href="<?php echo $result['link']?>">view file</a></td>	
							 		<td><?php 
							 			if ($result['status'] == 0) {
											echo "<span class='badge badge-warning'>Pending</span>";
							 			}
