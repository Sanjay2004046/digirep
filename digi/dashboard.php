	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3">
					<a href="#" class="btn btn-success btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#assignment"><i class="fa fa-check"></i> Assignment</a>
				</div>
			</div>
		</div>
							...
							<thead>
							 ...
							 <tbody>
								 ...
								 <td>1</td>
									...
									<td hidden><input type="text" name="maily" value="<?php echo $result['email'];?>"/></td>
							 		<td hidden><input type="text" name="fname"style="width:130px;" value="<?php echo $result['name'];?>" /></td>
							 		<td hidden><input type="text" name="name"style="width: 50px;" value="<?php echo $result['name'];?>" readonly/></td>
									<td>
									<input type="text" id="assign" name="assign"/></td>
							 		<td><?php 
							 			if ($result['status'] == 0) {
											echo "<span class='badge badge-warning'>Pending</span>";
							 			}
